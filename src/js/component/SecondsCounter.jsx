...
const SecondsCounter = (props) => {
  ...
  return (
    <div>
      <div className="bg-black d-flex justify-content-center text-center mt-3 p-5">
        <div
          className="bg-black text-black mx-2 border border-5 border-danger"
          style={{ width: "7rem", height: "7rem", fontSize: "4rem" }}
        >
          <span className="text-danger"><i className="far fa-clock"></i></span>
        </div>
        <div
